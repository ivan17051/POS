...
class ImportSIPMandiri extends Command
{
    protected $filepath = 'E:\Ivan\Dinkes\Data Pendukung Aplikasi\SDMK SIP\template-sipman.csv';
     ...
     * @var string
     */
    protected $signature = 'importsipman';
     ...
     * @var string
     */
    protected $description = 'Fungsi mengimport sip mandiri';
        ...
        if (($handle = fopen($this->filepath, "r")) !== FALSE) {
            ...
            try {
                ...
                while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
                    ...
                    if(!isset($str)){
                        throw new Exception("Nakes belum memiliki STR aktif ID ".$nakes->id);
                    }
                    ...
                    $sip = SIP::updateOrCreate(
                        ...
                        array_merge(
                            [
                                ...
                                "saranapraktik" => 'PRAKTIK MANDIRI',
                                "namafaskes" => 'PRAKTIK MANDIRI',
                                "alamatfaskes" => $data['alamatfaskes'],
