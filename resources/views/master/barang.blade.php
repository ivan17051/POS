      ...
      <form class="form-horizontal input-margin-additional" method="POST" action="{{route('barang.store')}}">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-3 checkbox-radios">
              <div class="form-check mt-2">
                <label class="form-check-label">
                  <input class="form-check-input" name="istitipan" type="checkbox"> Titipan
            ...
            <div class="col-md-4">
              <button type="button" class="btn btn-success btn-block" onclick="randomInt()">Generate</button>
            </div>
...
<div class="modal modal-custom-1 fade" id="sunting" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
...
<!--  End Modal Hapus  -->
<!-- Modal View Barcode -->
<div class="modal fade modal-mini modal-primary" id="view" tabindex="-1" role="dialog"
  aria-labelledby="myViewModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        ...
        <a href="" type="button" class="btn btn-outline-primary" id="btnCetak" target="_blank"
          rel="noreferrer noopener">Cetak</a>
        ...
        <div class="card-body">
          ...
          <div class="filter-tags" data-select="#selectrole" data-tags="#tagsinput" data-col="2">
            <div class="form-group d-inline-block" style="width: 150px;">
              <div class="row">
                <div class="col">
                  <select id="selectrole" class="selectpicker" data-style2="btn-default btn-round btn-sm text-white"
                    data-style="select-with-transition" multiple title="Filter Kategori" data-size="7"
            ...
            <div class="h-100 d-inline-block">
              <input id="tagsinput" hidden type="text" value="" class="form-control tagsinput" data-role="tagsinput"
                data-size="md" data-color="primary" data-role="filter">
            </div>
          </div>
          @endif
...
<script>
  ...
  function sunting(self) {
    ...
    $modal.find('input[name=istitipan]').prop('checked',data['istitipan']).change();
  ...
  function randomInt() {
    ...
    var kode = Math.floor(Math.random() * (max - min + 1)) + min;

    $.ajax({
      url: 'barang/checkkode/' + kode,
      type: "GET",
      dataType: "JSON",
      success: function (data) {
        // console.log(data);
        if (data == 0) {
          $('#kodebarang').val(kode).change();
        }
        else randomInt();
      }
    });
