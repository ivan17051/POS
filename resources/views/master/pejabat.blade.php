...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form-horizontal input-margin-additional" method="POST" action="{{route('pejabat.store')}}">
        @csrf
        <div class="modal-body">
            ...
            <label class="bmd-label force-top mt-1">Jabatan <small class="text-danger align-text-top">*wajib</small></label>
            <select id="jabatan" name="jabatan" class="selectpicker form-control" data-size="7" data-style="btn btn-primary btn-round" title="Pilih Jabatan" required>
            ...
            <div class="form-group mt-5">
                <label for="pangkat" class="bmd-label-floating">Pangkat</label>
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Sunting Data Pejabat </h4>
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            <i class="material-icons">clear</i>
            </button>
        </div>
        ...
        <div class="modal-body">
            ...
            <label class="bmd-label force-top mt-1">Jabatan <small class="text-danger align-text-top">*wajib</small></label>
            <select id="jabatan" name="jabatan" class="selectpicker form-control" data-size="7" data-style="btn btn-primary btn-round" title="Pilih Role" required>
                <option value="" disabled selected>Pilih Jabatan</option>
                <option>Kepala Dinas</option>
                <option>Kepala Bidang</option>
                <option>Sub Koordinator</option>
...
function onEdit(self) {
    ...
    $modal.find('[name=jabatan]').val(j['jabatan']).change().blur();
    $modal.find('[name=pangkat]').val(j['pangkat']).change();
    
    $modal.find('form').attr('action', "{{route('pejabat.update', ['id'=>''])}}/"+j['id']);
    $modal.modal('show');
} 
...
function onDelete(self) {
    ...
    $modal.find('form').attr('action', "{{route('pejabat.destroy', ['id'=>''])}}/"+j['id']);
    $modal.modal('show');
} 
