            ...
            <tr>
                <td class="jarak">
                    ...
                    <table class="w-89">
                      <tbody>
                        <tr>
                          <td class="" style="font-size:12px; width:45%;">Bukti Retur No. {{$retur->nomor}}</td>
                    ...
                    <table class="w-89" >
                      ...
                      <tbody class="tb-body font-13">
                        ...
                        $total = 0;
                        @endphp
                        @foreach($listBarang as $key=>$unit)
                        @php
                        $barang = explode('|', $unit);
                        @endphp
                        <tr>
                          <td class=" fontJustify">{{$key+1}}. </td>
                          <td class=" fontCenter">{{$barang[1]}}</td>
                          <td class=" fontJustify">{{$barang[0]}}</td>
                          <td class=" fontKanan">{{number_format($barang[2])}}</td>
                          <td class=" fontKanan">{{number_format($barang[1]*$barang[2])}}</td>
                        </tr>
                        @php
                    ...
                    <table class="w-89" style="margin-top:10px;">
                      <tbody>
                        <tr>
                          ...
                          <td class="fontKanan">{{number_format($retur->jumretur)}}</td>
                        </tr>
                        <tr>
                          <td style="width:50%;" rowspan="3">TERBILANG ##{{strtoupper(terbilang($retur->jumretur))}}##</td>
