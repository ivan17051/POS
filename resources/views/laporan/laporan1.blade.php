      ...
      <tr>
        <td class="jarak">
          ...
          <table cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                <td class="headerFont fontCenter  fontUnderline" style="font-size:16px">LAPORAN PENJUALAN BARANG</td>
              </tr>
              @if(isset($periode))
              <tr>
          ...
          <table class="w-85">
            <thead class="tb-header">
              <tr>
                ...
                <th class="headerFont fontCenter fontBold" style="font-size:13px; width:25%;">KODE BARANG</th>
            ...
            <tbody class="tb-body font-13">
              ...
              <tr>
                ...
                <td class=" fontJustify">{{$unit->getBarang->kodebarang}}</td>
                <td class=" fontCenter">{{$unit->getBarang->namabarang}}</td>
                <td class=" fontCenter">{{number_format($unit->qty)}}</td>
              </tr>
              @php
              $total += $unit->qty;
              @endphp
              @endforeach
              <tr>
                <td class=" fontCenter fontBold" colspan='3'>JUMLAH BARANG TERJUAL</td>
